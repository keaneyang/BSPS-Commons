 ...
 public class Constant { public static final int EOF_DELAY_DEFAULT = 1000;
   
   public static enum status { NORMAL, 
     END_OF_COLUMN, 
   ...
   public static int STRING_TYPE = 96;
   public static final int PARTIAL_ROW = 0;
   public static final int FULL_ROW = 1;
   public static enum eventType { ON_OPEN,  ON_CLOSE;
     private eventType() {} } public static int MAX_COLUMN_OFFSET_DEFAULT = 10240; public static int HEADER_LINE_NO_DEFAULT = 1;
   public static int MAX_COLUMN_COUNT = 10240;
   public static String REMOTE_ADDRESS_DEFAULT = "127.0.0.1";
   public static int PORT_NO_DEFAULT = 2012;
   ...
   public static final String DEFAULT_QUOTE_SET = Character.toString('"');
   ...
   public static String getCorrespondingClassForType(fieldType type)
   {
     switch (type) {
     case BYTE: 
